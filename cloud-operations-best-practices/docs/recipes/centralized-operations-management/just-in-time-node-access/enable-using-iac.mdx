...
| `JITNATargetAccounts` | (DA Configuration) Comma-separated list of AWS Organization Unit IDs where just-in-time node access is set up. (Local account) The AWS account ID for local account/Region enablement of just-in-time node access. | ou-a1b2-abcd1234,ou-a1b2-efgh1234,ou-a1b2-hijk1234 |
